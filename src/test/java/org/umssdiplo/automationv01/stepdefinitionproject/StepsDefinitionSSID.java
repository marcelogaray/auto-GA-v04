...
public class StepsDefinitionSSID {
    ...
    @When("^'Reporte de Inventarios' esta correctamente cargado$")
    public void validarListaDeInventories() throws Throwable {
        listInventory.isInventoryListVisible();
    }

    @Then("^Verificar Cabecera de reporte de Inventario contenido-imagen$")
    public void verificarCabeceraReporteInventario() throws Throwable {
        Assert.assertTrue(listInventory.checkHeaderReportInventory(), String.format(ErrorMessage.ERROR_MESSAGE_ELEMENT_VISIBLE, "Inventory title"));
    }
}